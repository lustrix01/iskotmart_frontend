...
export default function AdminLayout() {
  ...
  // Sidebar options based on your requested list
  const menuItems = [
    { name: "Dashboard", path: "/admin", icon: LayoutDashboard },
    { name: "Merchant Verification", path: "/admin/verify", icon: ShieldCheck },
    { name: "Account Management", path: "/admin/accounts", icon: Users },
    { name: "Operational Cost", path: "/admin/costs", icon: DollarSign },
    { name: "Moderators", path: "/admin/moderators", icon: UserCheck },
    { name: "Report Logs", path: "/admin/reports", icon: FileText },
    { name: "Account Logs", path: "/admin/logs", icon: History },
    {
        ...
        <div>
          ...
          <div className="h-16 flex items-center justify-center border-b border-white/10 bg-[#002244]">
            <Link to="/admin" className="text-2xl font-bold tracking-tight">
              ...
              <span className="text-[#FF851B]">Admin</span>
            </Link>
          </div>
                ...
                return (
                  <Link
                    ...
                    className={`flex items-center gap-3 px-4 py-3 rounded-lg text-xs transition-all group ${
                      isActive
                        ? "bg-white/10 text-white border-l-4 border-[#FF851B] font-black" // font-black makes it extra bold
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-2 pl-3 border-l border-gray-100">
              <div className="text-right">
                ...
                <p className="text-[9px] font-bold text-green-500 uppercase tracking-tighter mt-1">
                  System Root
                </p>
              </div>
