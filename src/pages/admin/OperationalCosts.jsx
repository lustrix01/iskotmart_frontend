...
import { History, Save, CheckCircle } from "lucide-react";
      ...
      <div className="grid grid-cols-1 gap-8">
        <SettingsCard
          ...
          inputs={[
            ...
            {
              label: "Min. Transaction Amount (PHP)",
        ...
        <SettingsCard
          ...
          inputs={[
            {
              label: "Featured Listing Fee (PHP)",
            ...
            {
              label: "Promoted Store Fee (PHP/day)",
