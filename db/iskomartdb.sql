...
ALTER TABLE `review`
  ...
  ADD UNIQUE KEY `REVIEW_CUSTOMER_OFFERING_ORDER_UNIQUE` (`CUSTOMER_ID`,`OFFERING_ID`,`ORDER_ID`),
  ADD UNIQUE KEY `REVIEW_CUSTOMER_OFFERING_REQUEST_UNIQUE` (`CUSTOMER_ID`,`OFFERING_ID`,`REQUEST_ID`);
...
ALTER TABLE `review`
  ...
  ADD CONSTRAINT `FK_REVIEW_ORDER_ID` FOREIGN KEY (`ORDER_ID`) REFERENCES `orders` (`ORDER_ID`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `FK_REVIEW_REQUEST_ID` FOREIGN KEY (`REQUEST_ID`) REFERENCES `service_request` (`REQUEST_ID`) ON DELETE NO ACTION ON UPDATE NO ACTION;
